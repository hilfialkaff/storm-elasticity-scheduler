...
public class Nimbus {
  ...
  public static class submitTopology_args implements org.apache.thrift.TBase<submitTopology_args, submitTopology_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(submitTopology_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetUploadedJarLocation()).compareTo(typedOther.isSetUploadedJarLocation());
      if (lastComparison != 0) {
        return lastComparison;
      }
      ...
      lastComparison = Boolean.valueOf(isSetJsonConf()).compareTo(typedOther.isSetJsonConf());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetJsonConf()) {
      ...
      lastComparison = Boolean.valueOf(isSetTopology()).compareTo(typedOther.isSetTopology());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetTopology()) {
  ...
  public static class submitTopology_result implements org.apache.thrift.TBase<submitTopology_result, submitTopology_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(submitTopology_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetIte()).compareTo(typedOther.isSetIte());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetIte()) {
